...
*   **Default View**: Displays net worth, monthly income/expense/EMIs/subscriptions/savings rate summaries on the top card along with a live **Safe-to-Spend Daily Run-Rate** (`₹X/day (Yd left)`), an **Upcoming Payments (14 days)** list summarizing soon-to-be-due EMIs and Subscriptions, **Recent Transactions** (restricting to the single most recent transaction date and capped at 3 items), and active budget meters.
